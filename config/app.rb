...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'unjustice-dropper-front.com'
  config.app_name = 'Unjustice-dropper-front'
  config.mailer.from = 'Unjustice-dropper-front <no-reply@unjustice-dropper-front.com>'
  ...
  #
  config.app_secret = 'ndXqyYsOcGM9xoUVQ7MSrOJhdyK3HOW3v4b3qqg3nHkQofDue-pl95mwPzCMS9NDB98'
